...
// DEV_COMMENT: ADDED new menu group for the Advertiser Portal.
const menuGroups = [
    {
    ...
    },
    {
        ...
        items: [
             { href: '/trip-organiser/leads', label: 'Leads', icon: Contact },
             { href: '/trip-organiser/coupons', label: 'Coupons', icon: Ticket },
        ]
    },
    {
    ...
    },
    {
        ...
        items: [
            ...
            { href: '/trip-organiser/billing', label: 'Billing', icon: Receipt },
...
const OrganizerSidebar = () => {
  ...
  const isLinkActive = (href: string) => {
    if (href === '/trip-organiser/dashboard' || href === '/advertiser/offers') {
...
export default function OrganizerLayout({
  ...
  const { loading, isAuthorized } = useAuthGuard('ORGANIZER');
